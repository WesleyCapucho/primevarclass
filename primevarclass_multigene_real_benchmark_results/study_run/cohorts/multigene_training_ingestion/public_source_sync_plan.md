...
### ClinVar - multigene_training_clinvar

- Release: -
- Automation level: automatable
- Sync strategy: direct_download
- Preferred channel: ftp_tsv
- Suggested local path: C:/Users/Wesley Capucho/Documents/IA dos números primos/primevarclass_multigene_real_benchmark_results/cohorts/multigene_training.tsv
- Readiness: 72%
