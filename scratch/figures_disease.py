...
ax.text(lx, 8.95, "Célula com BRCA1/BRCA2 funcionais", ha="center", fontsize=9.5, color=GN, fontweight="bold")
ax.text(rx, 8.95, "Portador(a) de variante patogênica", ha="center", fontsize=9.5, color=RD, fontweight="bold")
...
ax.text(5, 0.35,
        ...
        ha="center", va="center", fontsize=7.8, style="italic", color="#333333")
