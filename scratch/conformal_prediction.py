...
a1.set_title("A · A garantia de cobertura se cumpre", fontweight="bold", fontsize=11)
...
a2.set_title("B · Quanto mais confiança, mais o modelo se abstém", fontweight="bold", fontsize=11)
a2.legend(fontsize=9); a2.grid(axis="y", alpha=0.25)
