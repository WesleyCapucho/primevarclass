...
- Config path: C:\Users\Wesley Capucho\Documents\IA dos números primos\configs\public_brca_external_real_clinvar_expert_brca1.toml
- Sync candidates: 3
- Automatable: 2
- Semi-automatable: 1
- Manual-assisted: 0
...
### ClinVar - clinvar_expert_validation_brca1

- Release: 2026-04-03
- Automation level: automatable
- Sync strategy: direct_download
- Preferred channel: ftp_tsv
- Suggested local path: data/raw/clinvar/brca_missense_expert_external_brca1.tsv
- Readiness: 96%
