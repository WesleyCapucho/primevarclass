...
QUEUE_PATH = Path(r'''C:\Users\Wesley Capucho\Documents\IA dos números primos\primevarclass_public_sync_closure_results\gnomad_sync_queue.csv''')
CACHE_PATH = Path(r'''C:\Users\Wesley Capucho\Documents\IA dos números primos\primevarclass_public_sync_closure_results\gnomad_sync_cache.csv''')
BATCH_SIZE = 25
SLEEP_SECONDS = 6
