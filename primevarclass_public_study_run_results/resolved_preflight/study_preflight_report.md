# Public BRCA Benchmark Example - Study Preflight

- Generated at: 2026-04-03T04:29:32Z
- Overall preflight: 94%
...
- Status: partial
- Critical: yes
- Evidence: Readiness media de catalogo publico = 72%.
...
- public_brca_training (train): valid_rows=4, classes=2, public=72%, sync=2/3 automatable.
- bridges_like_external_validation (external_test): valid_rows=4, classes=2, public=72%, sync=2/3 automatable.
